...
public class MyIndexReader {
	...
	public long getCollectionLength() throws Exception {
//		int maxDoc = ireader.maxDoc();
//
//		long colLength = 0;
//		for (int i = 0; i < maxDoc; i++) {
//			if (i != 19949 && i != 45552 && i != 111051 && i != 111052 && i != 111496) {
//				colLength += docLength(i);
//				System.out.println(i);
//			}
//		}
//
//		System.out.println(colLength);
//		System.out.println(docLength(19950));
//		System.out.println(ireader.getSumTotalTermFreq("CONTENT"));
